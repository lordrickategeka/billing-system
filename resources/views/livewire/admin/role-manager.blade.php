        ...
        <div class="modal modal-open">
            <div class="modal-box">
                ...
                <div class="modal-action">
                    ...
                    <button wire:click="createRole" class="btn btn-primary">Create Role</button>
                </div>
            </div>
        </div>
    @endif
    ...
    @if($showEditModal)
        <div class="modal modal-open">
            <div class="modal-box">
                ...
                <div class="modal-action">
                    <button wire:click="closeModals" class="btn">Cancel</button>
                    <button wire:click="updateRole" class="btn btn-primary">Update Role</button>
                </div>
            </div>
        </div>
    @endif
    ...
    @if($showPermissionsModal)
        <div class="modal modal-open">
            <div class="modal-box max-w-4xl">
                <h3 class="font-bold text-lg mb-4">Manage Role Permissions</h3>
